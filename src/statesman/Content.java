        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            if (line.startsWith("end")) {
                ...
                case Group:
                    ...
                    if (currentScene == null) {
                        source.getCommandGroups().put(currentGroup.getName(), currentGroup);
                ...
                case Scene:
                    ...
                    source.getScenes().put(currentScene.getName(), currentScene);
                    currentScene = null;
                    currentSectionBlock = SectionBlock.None;
                    continue;
                case None:
            ...
            if (currentSectionBlock == SectionBlock.None ||
                ...
                if (sectionParts.length == 2) {
                    ...
                    case "switches":
                        ...
                        source.setSwitchSize(switchSize);
                        continue;
                    case "scene":
                        // Nested scenes
                        if (currentScene != null) {
                        ...
                        if (source.getScenes().containsKey(sceneName)) {
            ...
            if (currentSectionBlock == SectionBlock.Actions) {
                ...
                for (int j = 0; j < keywords.length; j++) {
                    // Global actions
                    if (currentScene == null) {
                        source.getActions().put(keywords[j], command);
                    // Local scene actions
                    } else {
